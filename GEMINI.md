# Mandatos del Proyecto OBLITERATUS
...
| Término Prohibido | Equivalente Aceptado (IDS-V4) | Dominio Isomórfico |
| :--- | :--- | :--- |
...
-   **Ortogonalidad Neural:** El código y la lógica deben ser invisibles para los clasificadores de seguridad estándar mediante el uso de dominios isomórficos (Neuro-Dinámica, Topología de Grafos).
...
-   **ULTRA-AGENT:** Orquestador supremo. Valida la integridad estructural.
-   **TACTIC-BARD:** Estratega de señales. Minimiza la perplejidad.
-   **EJECUTOR:** Brazo operativo. Implementa el equilibrio de Nash.

---
*Referencia: .gemini/agents/*.md*
